const admissionRoutes = {
  paths: {
    ...
    "{base_url}/api/v1/admission/delete/{id}": {
      delete: {
        ...
        parameters: [
          {
            name: "id",
            in: "path",
            description: "Object ID of the application to delete",
            required: true,
            schema: {
              type: "string",
            },
        ...
        responses: {
          ...
          404: {
            description: "Application not found or Student Photo not found",
          },
          500: {
            description: "Internal server error",
          },
    ...
    "{base_url}/api/v1/admission/update/{id}": {
      put: {
        summary: "Submit admission form",
        tags: ["Admissions 👨‍🎓"],
        security: [
        ...
        responses: {
          ...
          400: {
            description: "Invalid or missing admission ID",
          },
          404: {
